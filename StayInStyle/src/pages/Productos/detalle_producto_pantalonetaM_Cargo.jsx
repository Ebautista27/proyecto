    ...
    //////
          ...
          const agregarAlCarrito = () => {
            ...
            const nuevoProducto = {
                ...
                precio: producto?.precio ? parseFloat(producto.precio).toFixed(2) : "60.000 ", 
                imagen: producto?.imagen || "/public/productos/Pantalon_M_4.jpg", // Imagen por defecto si falta
            ...
            Swal.fire({
                ...
                html: `
                    ...
                    <p><strong>${"shorts cargo"}</strong></p>
    ...
    <div className="pagina-detalle">
      <div className="producto-detalle-container">
        <div className="producto-detalle">
          ...
          >
            <img src={producto?.imagen || "/public/productos/Pantalon_M_4.jpg"} />
            <div 
              className="zoom-lupa"
          ...
          <div className="producto-informacion">
            <h1>{producto?.nombre || "shorts cargo"}</h1>
            <p className="precio">{producto ? `$ ${producto.precio} COP` : "$ 60.000 COP"}</p>
            <form>
...
export default DetalleProducto19;
