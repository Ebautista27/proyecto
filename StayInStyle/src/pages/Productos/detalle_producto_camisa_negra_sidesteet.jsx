    ...
    //////
              ...
              const agregarAlCarrito = () => {
                ...
                const nuevoProducto = {
                    ...
                    imagen: producto?.imagen || "/public/productos/Camisa_M_3.jpg", // Imagen por defecto si falta
                ...
                Swal.fire({
                    ...
                    html: `
                        ...
                        <p><strong>${"Camisa SideStreet"}</strong></p>
    ...
    <div className="pagina-detalle">
      <div className="producto-detalle-container">
        <div className="producto-detalle">
          ...
          >
            <img src={producto?.imagen || "/public/productos/Camisa_M_3.jpg"} />
            <div 
              className="zoom-lupa"
          ...
          <div className="producto-informacion">
            <h1>{producto?.nombre || "Camisa SideStreet"}</h1>
...
>
  Añadir a la cesta
            ...
            <h5>DESCRIPCIÓN</h5>
            <p>
              {producto?.descripcion || "El diseño consiste en una figura humana estilizada en tonos de gris, con la cabeza reemplazada por el texto “SIDESTREET” en letras mayúsculas y un bloque de texto debajo que dice “PARENTAL ADVISORY EXPLICIT CONTENT”. El fondo es blanco y el logo “SIDESTREET EST. 1984” se repite a lo largo de los bordes inferiores de las mangas. Este diseño es relevante por su estilo urbano y contemporáneo, capturando la atención con su audaz tipografía y el uso del conocido sello de advertencia parental, sugiriendo una prenda dirigida a un público joven y consciente de la moda."}
            </p>
          </div>
        </div>
      </div>
...
export default DetalleProducto15;
