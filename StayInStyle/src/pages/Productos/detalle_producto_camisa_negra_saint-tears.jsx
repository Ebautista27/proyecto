     ...
     //////
                ...
                const agregarAlCarrito = () => {
                  ...
                  const nuevoProducto = {
                      ...
                      precio: producto?.precio ? parseFloat(producto.precio).toFixed(2) : "95.000 ", 
                      imagen: producto?.imagen || "/public/productos/Camisa_M_4.jpg", // Imagen por defecto si falta
                  ...
                  Swal.fire({
                      ...
                      html: `
                          ...
                          <p><strong>${"Camisa Saint Tears"}</strong></p>
    ...
    <div className="pagina-detalle">
      <div className="producto-detalle-container">
        <div className="producto-detalle">
          ...
          >
            <img src={producto?.imagen || "/public/productos/Camisa_M_4.jpg"} />
            <div 
              className="zoom-lupa"
          ...
          <div className="producto-informacion">
            <h1>{producto?.nombre || "Camisa Saint Tears"}</h1>
...
export default DetalleProducto16;
