    ...
    //////
                    ...
                    const agregarAlCarrito = () => {
                      ...
                      const nuevoProducto = {
                          ...
                          imagen: producto?.imagen || "/public/productos/Camisa_h_7.jpg", // Imagen por defecto si falta
    ...
    <div className="pagina-detalle">
      <div className="producto-detalle-container">
        <div className="producto-detalle">
          ...
          >
            <img src={producto?.imagen || "/public/productos/Camisa_h_7.jpg"} />
            <div 
              className="zoom-lupa"
          ...
          <div className="producto-informacion">
            <h1>{producto?.nombre || "Camisa Overzice Sencilla"}</h1>
...
export default DetalleProducto8;
