  ...
  /////
    ...
    const agregarAlCarrito = () => {
      ...
      const nuevoProducto = {
        ...
        precio: producto?.precio ? parseFloat(producto.precio).toFixed(2) : "150.000",
        imagen: producto?.imagen || "/public/productos/prenda_video.jpeg", // Imagen por defecto si falta
      ...
      Swal.fire({
        ...
        html: `
                 <img src="${nuevoProducto.imagen}" alt="${nuevoProducto.nombre}" width="100px" />
                   <p><strong>${"Chaqueta Azul Nike x NOCTA"}</strong></p>
    ...
    <div className="pagina-detalle">
      <div className="producto-detalle-container">
        <div className="producto-detalle">
          ...
          >
            <img src={producto?.imagen || "/public/productos/prenda_video.jpeg"} />
            <div 
              className="zoom-lupa"
          ...
          <div className="producto-informacion">
            <h1>{producto?.nombre || "Chaqueta Azul Nike x NOCTA"}</h1>
            <p className="precio">{producto ? `$ ${producto.precio} COP` : "$ 150.000COP"}</p>
            <form>
...
export default DetalleProducto21;
