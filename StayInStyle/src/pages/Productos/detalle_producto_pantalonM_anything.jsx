    ...
    //////
        ...
        const agregarAlCarrito = () => {
          ...
          const nuevoProducto = {
              ...
              imagen: producto?.imagen || "/public/productos/pantalon_M_1.jpeg", // Imagen por defecto si falta
          ...
          Swal.fire({
              ...
              html: `
                  ...
                  <p><strong>${"Pantalon Anything"}</strong></p>
    ...
    <div className="pagina-detalle">
      <div className="producto-detalle-container">
        <div className="producto-detalle">
          ...
          >
            <img src={producto?.imagen || "/public/productos/pantalon_M_1.jpeg"} />
            <div 
              className="zoom-lupa"
          ...
          <div className="producto-informacion">
            <h1>{producto?.nombre || "Pantalon Anything"}</h1>
...
export default DetalleProducto17;
