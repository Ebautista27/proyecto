...
// CARRUSEEEL TOCA ARREGLARLO
const DetalleProducto23 = () => {
  const { id } = useParams();
  ...
  //////
            ...
            const agregarAlCarrito = () => {
              ...
              const nuevoProducto = {
                  ...
                  imagen: producto?.imagen || "/public/productos/camiseta carrusel.jpeg", // Imagen por defecto si falta
              ...
              Swal.fire({
                  ...
                  html: `
                      ...
                      <p><strong>${"TIDAL BLUE Paneled Oversized Jersey"}</strong></p>
    ...
    <div className="pagina-detalle">
      <div className="producto-detalle-container">
        <div className="producto-detalle">
          ...
          >
            <img src={producto?.imagen || "/public/productos/camiseta carrusel.jpeg"} />
            <div 
              className="zoom-lupa"
          ...
          <div className="producto-informacion">
            <h1>{producto?.nombre || "TIDAL BLUE Paneled Oversized Jersey"}</h1>
...
>
  Añadir a la cesta
            ...
            <h5>DESCRIPCIÓN</h5>
            <p>
              {producto?.descripcion || "El 'TIDAL BLUE' Paneled Oversized Jersey destaca por su diseño audaz y su ajuste relajado. Con un vibrante colorazul marea, esta prenda presenta paneles contrastantesque aportan un toque moderno y dinámico. Confeccionadoen un tejido suave y de alta calidad, ofrece un confortexcepcional y una caída fluida. Ideal para quienesbuscan una mezcla de estilo contemporáneo y comodidadsin esfuerzo."}
            </p>
          </div>
        </div>
      </div>
...
export default DetalleProducto23;
