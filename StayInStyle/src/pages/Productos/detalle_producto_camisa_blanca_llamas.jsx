...
const DetalleProducto7 = () => {
  ...
  const agregarAlCarrito = () => {
    ...
    const nuevoProducto = {
      ...
      precio: producto?.precio ? parseFloat(producto.precio).toFixed(2) : "85.000 ",
      imagen: producto?.imagen || "/public/productos/Camisa_H_6.jpg", // Imagen por defecto si falta
    ...
    Swal.fire({
      ...
      html: `
               <img src="${nuevoProducto.imagen}" alt="${nuevoProducto.nombre}" width="100px" />
                 <p><strong>${"Camisa Overzice ATSOBER"}</strong></p>
    ...
    <div className="pagina-detalle">
      <div className="producto-detalle-container">
        <div className="producto-detalle">
          ...
          >
            <img src={producto?.imagen || "/public/productos/Camisa_H_6.jpg"} />
            <div
              className="zoom-lupa"
          ...
          <div className="producto-informacion">
            <h1>{producto?.nombre || "Camisa Overzice ATSOBER"}</h1>
            <p className="precio">{producto ? `$ ${producto.precio} COP` : "$ 85.000 COP"}</p>
            <form>
...
export default DetalleProducto7;
