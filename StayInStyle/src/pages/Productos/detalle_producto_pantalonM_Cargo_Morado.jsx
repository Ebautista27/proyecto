  ...
  //////
      ...
      const agregarAlCarrito = () => {
        ...
        const nuevoProducto = {
            ...
            imagen: producto?.imagen || "/public/productos/Pantalon_M_3.jpg", // Imagen por defecto si falta
        ...
        Swal.fire({
            ...
            html: `
                ...
                <p><strong>${"Cargo Morado"}</strong></p>
    ...
    <div className="pagina-detalle">
      <div className="producto-detalle-container">
        <div className="producto-detalle">
          ...
          >
            <img src={producto?.imagen || "/public/productos/Pantalon_M_3.jpg"} />
            <div 
              className="zoom-lupa"
          ...
          <div className="producto-informacion">
            <h1>{producto?.nombre || "Cargo Morado"}</h1>
...
>
  Añadir a la cesta
            ...
            <h5>DESCRIPCIÓN</h5>
            <p>
              {producto?.descripcion || "Estos pantalones cargo de corte amplio en color púrpura son una pieza audaz y versátil. Confeccionados en un material resistente y con múltiples bolsillos grandes a lo largo de las piernas, ofrecen tanto funcionalidad como estilo. El diseño de cintura alta y los detalles de costura visible añaden un toque moderno, mientras que los puños elásticos en la parte inferior proporcionan un ajuste cómodo y ajustado. Perfectos para un look urbano y desenfadado."}
            </p>
          </div>
        </div>
      </div>
...
export default DetalleProducto18;
