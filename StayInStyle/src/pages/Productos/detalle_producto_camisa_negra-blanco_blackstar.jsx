  ...
  //////
            ...
            const agregarAlCarrito = () => {
              ...
              const nuevoProducto = {
                  ...
                  precio: producto?.precio ? parseFloat(producto.precio).toFixed(2) : "70.000 ", 
                  imagen: producto?.imagen || "/public/productos/Camisa_H_2.jpg", // Imagen por defecto si falta
              ...
              Swal.fire({
                  ...
                  html: `
                      ...
                      <p><strong>${"Camisa BlackStar"}</strong></p>
    ...
    <div className="pagina-detalle">
      <div className="producto-detalle-container">
        <div className="producto-detalle">
          ...
          >
            <img src={producto?.imagen || "/public/productos/Camisa_H_2.jpg"} />
            <div 
              className="zoom-lupa"
          ...
          <div className="producto-informacion">
            <h1>{producto?.nombre || "Camisa BlackStar"}</h1>
            <p className="precio">{producto ? `$ ${producto.precio} COP` : "$ 70.000 COP"}</p>
            <form>
...
export default DetalleProducto11;
