   ...
   //////
            ...
            const agregarAlCarrito = () => {
              ...
              const nuevoProducto = {
                  ...
                  precio: producto?.precio ? parseFloat(producto.precio).toFixed(2) : "250.000 ", 
                  imagen: producto?.imagen || "/public/productos/chaqueta negra carrusel.jpeg", // Imagen por defecto si falta
              ...
              Swal.fire({
                  ...
                  html: `
                      ...
                      <p><strong>${"Black Fleece Jacket 2.0 Trendt Vision"}</strong></p>
    ...
    <div className="pagina-detalle">
      <div className="producto-detalle-container">
        <div className="producto-detalle">
          ...
          >
            <img src={producto?.imagen || "/public/productos/chaqueta negra carrusel.jpeg"} />
            <div 
              className="zoom-lupa"
          ...
          <div className="producto-informacion">
            <h1>{producto?.nombre || "Black Fleece Jacket 2.0 Trendt Vision"}</h1>
            <p className="precio">{producto ? `$ ${producto.precio} COP` : "$ 250.000 COP"}</p>
            <form>
...
export default DetalleProducto22;
