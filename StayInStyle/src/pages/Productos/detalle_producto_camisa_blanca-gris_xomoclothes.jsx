  ...
  useEffect(() => {
    ...
    console.log("Producto antes de agregar:", producto); // 🔍 Verifica que tenga datos
     ...
     nombre: producto?.nombre,
             precio: producto?.precio ? parseFloat(producto.precio).toFixed(2) : "98.000", 
            imagen: producto?.imagen || "/public/productos/camiseta gris bbs.jpeg", // Imagen por defecto si falta
         ...
         Swal.fire({
           title: "Añadido al carrito",
             ...
             <img src="${nuevoProducto.imagen}" alt="${nuevoProducto.nombre}" width="100px" />
               <p><strong>${"Camisa Overzice XOMOCLOTHES"}</strong></p>
    ...
    <div className="pagina-detalle">
      <div className="producto-detalle-container">
        <div className="producto-detalle">
          ...
          >
            <img src={producto?.imagen || "/public/productos/camiseta gris bbs.jpeg"} />
            <div 
              className="zoom-lupa"
          ...
          <div className="producto-informacion">
            <h1>{producto?.nombre || "Camisa Overzice XOMOCLOTHES"}</h1>
            <p className="precio">{producto ? `$ ${producto.precio} COP` : "$ 98.000 COP"}</p>
            <form>
...
export default DetalleProducto10;
