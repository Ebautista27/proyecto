    ...
    fetchProducto();
      ...
      console.log("Producto antes de agregar:", producto); // 🔍 Verifica que tenga datos
       ...
       nombre: producto?.nombre,
               precio: producto?.precio ? parseFloat(producto.precio).toFixed(2) : "80.000 ", 
              imagen: producto?.imagen || "/public/productos/Camisa_H_4.jpg", // Imagen por defecto si falta
           ...
           Swal.fire({
             title: "Añadido al carrito",
               ...
               <img src="${nuevoProducto.imagen}" alt="${nuevoProducto.nombre}" width="100px" />
                 <p><strong>${"Camisa Blanca Overzice A3ORFEND"}</strong></p>
    ...
    <div className="pagina-detalle">
      <div className="producto-detalle-container">
        <div className="producto-detalle">
          ...
          >
            <img src={producto?.imagen || "/public/productos/Camisa_H_4.jpg"} />
            <div 
              className="zoom-lupa"
          ...
          <div className="producto-informacion">
            <h1>{producto?.nombre || "Camisa Blanca Overzice A3ORFEND"}</h1>
            <p className="precio">{producto ? `$ ${producto.precio} COP` : "$ 80.000 COP"}</p>
            <form>
...
>
  Añadir a la cesta
            ...
            <h5>DESCRIPCIÓN</h5>
            <p>
              {producto?.descripcion || "Una camiseta blanca de algodón, de corte holgado, con un gran logo negro 'A3OFEND' impreso en el centro del pecho. El logo presenta un diseño geométrico abstracto con detalles en gris y rojo, creando un contraste llamativo con el fondo blanco."}
            </p>
          </div>
        </div>
      </div>
...
export default DetalleProducto5;
