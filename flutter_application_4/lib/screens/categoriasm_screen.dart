...
class CategoriasmScreen extends StatefulWidget {
  @override
  _CategoriasmScreenState createState() => _CategoriasmScreenState();
}

class _CategoriasmScreenState extends State<CategoriasmScreen> {
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        final productosHombres = data
          .where((producto) => producto['id_genero'] == 2)
          .map((producto) => {
                ...producto,
